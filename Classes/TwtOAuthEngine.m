...
@interface TwtOAuthEngine (private)
...
+ (TwtOAuthEngine *) OAuthTwitterEngineWithDelegate: (NSObject *) delegate {
    return [[[TwtOAuthEngine alloc] initOAuthWithDelegate: delegate] autorelease];
}


- (TwtOAuthEngine *) initOAuthWithDelegate: (NSObject *) delegate {
...
- (void) clearAccessToken 
{
	if ([_delegate respondsToSelector: @selector(storeCachedTwitterOAuthData:forUsername:)]) 
		[(id) _delegate storeCachedTwitterOAuthData: @"" forUsername: self.username];
